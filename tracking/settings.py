...
DEBUG = os.path.isfile('local.env')
...
CELERY_IMPORTS = ('commons.tasks.sale',)
CELERY_APP = 'tracking.celery:app'
CELERY_TIMEZONE = 'UTC'
...
DATABASES = {
    ...
    "default": {
        ...
        "NAME": "tracking",
        "USER": "postgres",
        "PASSWORD": "XzRYChcB1rf9RvSb",
        "HOST": "tracking-app-rds.cz1snkxjiums.us-east-1.rds.amazonaws.com",
        "PORT": "5432",
    }
}
